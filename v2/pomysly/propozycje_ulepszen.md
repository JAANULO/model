...
### A. Metoda "N-Gramów" (Wyszukiwanie Frzeologiczne)
...
### B. Izolacja WAG - Podwójny System Ocen (Tytuł vs Treść)
...
### C. Pseudo-Relevance Feedback (Algorytm Rocchio)
...
### D. Polepszenie Oboczności (Rozbudowa Stemmera)
...
### A. Okno Uściślania Wątpliwości (Disambiguation)
...
### B. Highlighting Zdania W Pełnym Treści
...
### C. Podpowiedzi Rozbiegowe (Onboarding Starter Pack)
...
### D. System Szybkiego Dopisywania Słowników z Ciemni (Admin Panel)
